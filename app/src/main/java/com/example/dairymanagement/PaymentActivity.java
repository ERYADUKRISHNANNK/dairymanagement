...
PaymentActivity extends Activity implements PaymentResultWithDataListener, ExternalWalletListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.btn_pay);
         amt = Integer.parseInt(getIntent().getExtras().getString("p"))+"00";
        ...
        TextView privacyPolicy = (TextView) findViewById(R.id.t1);
